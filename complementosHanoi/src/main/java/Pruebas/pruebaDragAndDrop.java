 ...
 * @author phily
 */
public class pruebaDragAndDrop extends JPanel{
   private Rectangle2D.Float myRect = new Rectangle2D.Float(90, 90, 90, 90);
   BindMouseMove movingAdapt = new BindMouseMove();
 
    public pruebaDragAndDrop() { 
        addMouseMotionListener((MouseMotionListener) movingAdapt); 
        addMouseListener((MouseListener) movingAdapt);
 
        addMouseWheelListener((MouseWheelListener) new ResizeHandler());
    }
    ...
    public static void main(String[] args) { 
        ...
        pruebaDragAndDrop resi = new pruebaDragAndDrop();
